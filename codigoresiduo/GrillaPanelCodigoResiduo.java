...
public class GrillaPanelCodigoResiduo extends JPanel {
    private JTable table;

    public GrillaPanelCodigoResiduo() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(BorderFactory.createTitledBorder("Tabla_Código_Residuo"));
        setLayout(new BorderLayout());

        DefaultTableModel model = new DefaultTableModel(
            new Object[]{"Código", "Descripción", "Estado Registro"}, 0
        ) {
            @Override
