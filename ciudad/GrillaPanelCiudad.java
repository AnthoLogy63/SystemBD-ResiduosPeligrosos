...
public class GrillaPanelCiudad extends JPanel {
    private JTable table;

    public GrillaPanelCiudad() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(BorderFactory.createTitledBorder("Tabla_Ciudad"));
        setLayout(new BorderLayout());

        DefaultTableModel model = new DefaultTableModel(
            new Object[]{"Código", "Nombre", "Estado Registro", "Región"}, 0
        ) {
            @Override
        ...
        DefaultTableCellRenderer renderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(
                    JTable t, Object val,
                    boolean selRow, boolean hasFocus,
                    int row, int col) {
        ...
        colModel.getColumn(1).setPreferredWidth(200); // Nombre
        colModel.getColumn(2).setPreferredWidth(100); // Estado
        colModel.getColumn(3).setPreferredWidth(100); // Región
