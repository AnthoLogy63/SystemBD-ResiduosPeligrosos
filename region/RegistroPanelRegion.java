...
public class RegistroPanelRegion extends JPanel {
    private JTextField tfCodigo;
    private JTextField tfNombre;
    private JTextField tfEstado;

    public RegistroPanelRegion() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(new CompoundBorder(
            BorderFactory.createTitledBorder("Registro de Región"),
        ...
        // Código (máx. 3 caracteres alfabéticos)
        ...
        // Nombre (máx. 40 caracteres alfanuméricos + espacios)
        ...
        ((AbstractDocument) tfNombre.getDocument()).setDocumentFilter(new UsarAlfaNumerico(40));
        add(tfNombre, gbc);
    ...
    // Filtro para letras (para el código tipo ARE, LIM, etc.)
    ...
    // Filtro para letras, números y espacios (para el nombre)
