...
public class BotonesPanelTransportista extends JPanel {
    ...
    public BotonesPanelTransportista() {
        setLayout(new BorderLayout());
        setBackground(baseColor);

        // Panel de botones principales
        JPanel panelCentral = new JPanel(new GridLayout(2, 4, 40, 20));
        ...
        for (String text : texts) {
            ...
            btn.addMouseListener(new MouseAdapter() {
                ...
                public void mouseExited(MouseEvent e) {
                    btn.setBackground(Boolean.TRUE.equals(btn.getClientProperty("active")) ? activeColor : baseColor);
                }
            });
        ...
        // Agregamos solo el panel de botones al centro
