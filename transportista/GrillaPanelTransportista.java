...
public class GrillaPanelTransportista extends JPanel {
    private JTable table;

    public GrillaPanelTransportista() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(BorderFactory.createTitledBorder("Tabla de Transportistas"));
        setLayout(new BorderLayout());

        DefaultTableModel model = new DefaultTableModel(
            new Object[]{"NIF", "Nombre", "Ciudad", "Tipo Transporte", "Estado", "Observación"}, 0
        ) {
            @Override
        ...
        colModel.getColumn(0).setPreferredWidth(100); // NIF
        colModel.getColumn(1).setPreferredWidth(180); // Nombre
        colModel.getColumn(2).setPreferredWidth(80);  // Ciudad
        colModel.getColumn(3).setPreferredWidth(120); // Tipo Transporte
        colModel.getColumn(4).setPreferredWidth(60);  // Estado
        colModel.getColumn(5).setPreferredWidth(180); // Observación
