...
public class BotonesPanelToxicidad extends JPanel {
        ...
        for (String text : texts) {
            ...
            btn.addMouseListener(new MouseAdapter() {
                ...
                @Override public void mouseExited(MouseEvent e) {
                    btn.setBackground(
                        btn.getClientProperty("active") == Boolean.TRUE ? activeColor : baseColor
                    );
                }
            });
