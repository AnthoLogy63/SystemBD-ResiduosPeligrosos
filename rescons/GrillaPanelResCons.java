...
public class GrillaPanelResCons extends JPanel {
    private JTable table;

    public GrillaPanelResCons() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(BorderFactory.createTitledBorder("Tabla de Residuos-Constituyentes"));
        setLayout(new BorderLayout());

        DefaultTableModel model = new DefaultTableModel(
            new Object[]{"Empresa (NIF)", "Código Residuo", "Código Constituyente", "Cantidad", "Estado"}, 0
        ) {
            @Override
        ...
        DefaultTableCellRenderer renderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object val, boolean selRow, boolean hasFocus, int row, int col) {
                ...
                setHorizontalAlignment((col == 3 || col == 4) ? SwingConstants.CENTER : SwingConstants.LEFT);
                return this;
            }
        };
        ...
        // Ajustes de ancho
        colModel.getColumn(0).setPreferredWidth(130); // Empresa
        colModel.getColumn(1).setPreferredWidth(120); // Residuo
        colModel.getColumn(2).setPreferredWidth(140); // Constituyente
        colModel.getColumn(3).setPreferredWidth(80);  // Cantidad
        colModel.getColumn(4).setPreferredWidth(60);  // Estado
