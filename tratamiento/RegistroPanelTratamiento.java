...
public class RegistroPanelTratamiento extends JPanel {
    private JTextField tfCodigo;
    private JTextField tfNombre;
    private JTextField tfEstado;

    public RegistroPanelTratamiento() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(new CompoundBorder(
            BorderFactory.createTitledBorder("Registro de Tratamiento"),
        ...
        // Nombre (máx. 40 caracteres alfanuméricos y espacios)
