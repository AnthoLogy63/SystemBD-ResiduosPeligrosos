...
public class GrillaPanelTipTran extends JPanel {
    private JTable table;

    public GrillaPanelTipTran() {
        ...
        table.setFocusable(false); // opcional: evita foco visible

        // Renderer unificado para todas las columnas
