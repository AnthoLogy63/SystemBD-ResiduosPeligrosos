...
public class BotonesPanelEmpresa extends JPanel {
    ...
    public BotonesPanelEmpresa() {
        ...
        // Y al final, en lugar de add(panelInferior), simplemente:
        add(panelCentral, BorderLayout.CENTER);
        // No agregues panelInferior aquí (porque ya lo agregaremos desde afuera)
