...
public class GrillaPanelEmpresa extends JPanel {
    private JTable table;

    public GrillaPanelEmpresa() {
        setBackground(Color.decode("#FFFFFF"));
        setBorder(BorderFactory.createTitledBorder("Tabla de Empresas"));
        setLayout(new BorderLayout());

        DefaultTableModel model = new DefaultTableModel(
            new Object[]{"NIF", "Nombre", "Ciudad", "Actividad", "Observación", "Estado"}, 0
        ) {
            @Override
        ...
        colModel.getColumn(3).setPreferredWidth(160); // Actividad
        colModel.getColumn(4).setPreferredWidth(180); // Observación
        colModel.getColumn(5).setPreferredWidth(60);  // Estado
